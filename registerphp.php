...
if (isset($_POST['register_click'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO registered_users (fname,  faddress,  fpincode,  fusername, fpassword, fphone) VALUES ( ?, ?, ?, ?, ?, ?)");

    // Bind parameters with appropriate data types and order
    $stmt->bind_param("ssissi", $fname,  $faddress,  $fpincode,  $fusername, $fpassword, $fphone);
